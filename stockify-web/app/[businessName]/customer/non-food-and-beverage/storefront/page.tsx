...
import { ProductModal } from "@/components/modals/storefront/nfnb/product-modal";

// --- Retail Mock Data ---
const categories = ["All Products", "Apparel", "Bags", "Accessories", "Lifestyle"];

const products = [
  { id: 1, name: "Classic Denim Jacket", category: "Apparel", description: "Vintage wash, 100% cotton denim", rating: 4.8, price: "2450.00", image: "🧥" },
  { id: 2, name: "Minimalist Leather Tote", category: "Bags", description: "Genuine leather with laptop sleeve", rating: 4.9, price: "3200.00", image: "👜" },
  { id: 3, name: "Polarized Sunglasses", category: "Accessories", description: "UV400 protection, matte black frame", rating: 4.6, price: "850.00", image: "🕶️" },
  { id: 4, name: "Everyday Cotton Tee", category: "Apparel", description: "Breathable, pre-shrunk cotton blend", rating: 4.7, price: "550.00", image: "👕" },
  { id: 5, name: "Ceramic Coffee Mug", category: "Lifestyle", description: "Handcrafted 12oz speckled ceramic", rating: 4.9, price: "600.00", image: "🏺" },
  { id: 6, name: "Canvas Weekend Duffle", category: "Bags", description: "Water-resistant with shoe compartment", rating: 4.8, price: "2800.00", image: "🎒" },
  { id: 7, name: "Stainless Steel Bottle", category: "Lifestyle", description: "24hr cold / 12hr hot insulation", rating: 4.7, price: "950.00", image: "🫙" },
  { id: 8, name: "Woven Braided Belt", category: "Accessories", description: "Stretch fit with leather trim", rating: 4.5, price: "450.00", image: "🎗️" },
];

const banners = [
  { id: 1, title: "End of Season Sale", subtitle: "Up to 40% off on all outerwear and selected accessories.", bgGradient: "from-[#2A4725] to-[#385E31]", image: "🏷️" },
  { id: 2, title: "New Arrivals", subtitle: "Explore our latest collection of sustainable everyday wear.", bgGradient: "from-[#385E31] to-[#4A7540]", image: "✨" },
  { id: 3, title: "Free Shipping", subtitle: "Enjoy free standard shipping nationwide on orders over ₱3,000.", bgGradient: "from-[#2A4725] to-[#1a2e17]", image: "📦" }
];
...
export default function RetailStorefront() {
  ...
  // (Removed isCartOpen and fulfillment state since they belong on the cart page now)
    ...
    <div className="min-h-screen w-full bg-[#FFFCEB] font-['Inter'] flex flex-col overflow-x-hidden text-[#3A6131]">
      ...
      <div className="w-full bg-[#2A4725] flex justify-center py-2 px-4 gap-4 sm:gap-8 overflow-hidden whitespace-nowrap">
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="flex items-center gap-2 text-[#F7B71D] text-[11px] sm:text-[12px] font-medium">
          <Truck size={14} /> <span className="hidden sm:inline">Free Shipping over ₱3,000</span><span className="sm:hidden">Free Ship ₱3k</span>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="flex items-center gap-2 text-[#F7B71D] text-[11px] sm:text-[12px] font-medium">
          <ShieldCheck size={14} /> <span>30-Day Returns</span>
        </motion.div>
        <div className="w-px h-4 bg-[#F7B71D]/30" />
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex items-center gap-2 text-[#F7B71D] text-[11px] sm:text-[12px] font-medium">
          <Package size={14} /> <span className="hidden sm:inline">Nationwide Delivery</span><span className="sm:hidden">PH Delivery</span>
        </motion.div>
      </div>
        ...
        <div className="w-full max-w-[1470px] mx-auto px-4 sm:px-6 py-3 sm:py-4 flex justify-between items-center gap-4">
          ...
          <motion.div whileHover={{ scale: 1.02 }} className="flex items-center gap-3 cursor-pointer min-w-max">
            ...
            <div className="hidden sm:flex flex-col">
              <h1 className="text-[#F7B71D] text-[18px] sm:text-[20px] font-extrabold tracking-wide uppercase leading-tight">Aura Goods</h1>
      ...
      <main className="flex-1 w-full max-w-[1300px] mx-auto px-4 sm:px-6 py-6 sm:py-8 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4 sticky top-[72px] sm:top-[80px] z-30 bg-[#FFFCEB]/95 backdrop-blur-md pt-4 -mx-4 px-4 sm:mx-0 sm:px-0">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <h2 className="text-[24px] font-bold text-[#3A6131] flex items-center gap-2">Collections</h2>
