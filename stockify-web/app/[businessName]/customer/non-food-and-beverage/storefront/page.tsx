...
export default function NfnbStorefront() {
  ...
  const c = {
    ...
    font: sfConfig?.font_family ?? "Inter",
  };

  // Format font name for Google Fonts API
  const fontQuery = c.font.replace(/ /g, "+");
    ...
    <>
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            @import url('https://fonts.googleapis.com/css2?family=${fontQuery}:wght@400;500;600;700;800&display=swap');
            
            .storefront-wrapper {
              font-family: "${c.font}", sans-serif !important;
            }
          `,
        }}
      />
      ...
      <div 
        className="storefront-wrapper min-h-screen w-full flex flex-col overflow-x-hidden" 
        style={{ 
      ...
      >
        ...
        <CustomerHeader
          ...
          // Prioritize the storefront config logo over the base tenant table
          tenantLogo={sfConfig?.logo_url || tenant?.logo_url || undefined}
