    ...
    <div className="min-h-screen bg-white flex overflow-x-hidden">
      ...
      <main className="ml-64 flex-1 px-4 py-6 sm:px-6 sm:py-8">
        <div className="mx-auto w-full max-w-6xl space-y-6">
          ...
          <div className="w-[1005.84px] h-12 inline-flex flex-col justify-start items-start gap-[3.23px]">
            ...
            <div className="h-96 inline-flex justify-start items-center gap-5">
            <div className="w-[672.83px] h-96 bg-lime-950 rounded-xl outline outline-[0.82px] outline-offset-[-0.82px] outline-lime-800/20 inline-flex flex-col justify-start items-start gap-5">
            ...
            <div className="w-80 h-96 p-px bg-white rounded-xl outline outline-[0.87px] outline-offset-[-0.87px] outline-lime-800/20 inline-flex flex-col justify-start items-start gap-5">
            ...
            <div className="w-[1005.84px] h-80 relative bg-white rounded-xl outline outline-[0.81px] outline-offset-[-0.81px] outline-lime-800/20">
            <div className="w-[965.42px] h-56 left-[20.21px] top-[76.81px] absolute overflow-hidden">
                <div className="w-[965.42px] h-9 left-0 top-0 absolute">
                <div className="w-[965.42px] h-9 left-0 top-0 absolute border-b-[0.81px] border-lime-800/20">
                    <div className="w-44 h-9 px-3 py-2.5 left-0 top-0 absolute inline-flex justify-start items-start">
            ...
            <div className="w-28 h-7 left-[869.74px] top-[21.83px] absolute bg-white rounded-md outline outline-[0.81px] outline-offset-[-0.81px] outline-lime-800/30">
            ...
            <div className="w-56 h-3 left-[20.21px] top-[20.21px] absolute">
            ...
            <div className="w-56 h-5 left-[20.21px] top-[33.15px] absolute">
            ...
            <div className="w-[965.42px] h-10 relative">
            ...
            <div className="w-64 h-7 relative rounded-xl">
            <div className="w-64 h-7 px-[2.43px] left-0 top-0 absolute bg-lime-800/10 rounded-xl inline-flex justify-center items-center">
                <div className="flex-1 h-6 px-1.5 py-[3.23px] bg-white rounded-xl outline outline-[0.81px] outline-offset-[-0.81px] outline-black/0 flex justify-center items-center gap-[4.85px]">
                <div className="text-center justify-start text-neutral-950 text-xs font-medium font-['Inter'] leading-4">Billing History</div>
                </div>
                <div className="flex-1 h-6 px-1.5 py-[3.23px] rounded-xl outline outline-[0.81px] outline-offset-[-0.81px] outline-black/0 flex justify-center items-center gap-[4.85px]">
                <div className="text-center justify-start text-neutral-950 text-xs font-medium font-['Inter'] leading-4">Usage Details</div>
                </div>
            </div>
</div>
