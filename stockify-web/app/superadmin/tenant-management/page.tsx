...
const pendingData = [
  { id: 101, name: "Sari-Sari Plus", owner: "Juan Dela Cruz", date: "04/05/2026" },
  { id: 102, name: "Cebuano Eats", owner: "Maria Santos", date: "04/06/2026" },
  { id: 103, name: "Techie Gadgets", owner: "Pedro Penduko", date: "04/06/2026" },
  { id: 104, name: "Fresh Catch", owner: "Nene Ramos", date: "04/07/2026" },
  { id: 105, name: "Kape at Pandesal", owner: "Lito Lapid", date: "04/07/2026" },
  { id: 106, name: "City Hardware", owner: "Boy Abunda", date: "04/08/2026" },
  { id: 107, name: "Mandaue Crafts", owner: "Inday Sara", date: "04/08/2026" },
  { id: 108, name: "Sugbo Sweets", owner: "Lapu Lapu", date: "04/09/2026" },
];
      ...
      <div className="flex-1 flex flex-col h-full overflow-y-auto px-10 md:px-20 pt-5 pb-12">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          <StatCard 
            ...
            value="43" 
            trendText="↑ 3% this month (January)" 
            svgName="SA-active-tenants" 
          />
          <StatCard 
            title="Pending Applications" 
            value="39" 
            trendText="39 new applications await review" 
            svgName="SA-pending-app" 
          />
          <StatCard 
            title="Suspended Tenants" 
            value="12" 
            trendText="12 tenants temporarily suspended" 
            svgName="SA-suspended-tenants" 
          />
          <StatCard 
            title="Terminated Tenants" 
            value="9" 
            trendText="9 tenants were terminated" 
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    setActiveTab(tab);
                    setOpenDropdownId(null); // Close any open dropdowns when switching tabs
                  }}
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="w-full bg-[#FFFCEB] rounded-[10px] border border-[#385E31] flex flex-col overflow-visible shadow-sm">
            ...
            <div className="w-full flex bg-[#385E31] px-4 py-3 rounded-t-[8px]">
              ...
              {/* Terminated tab has no additional columns */}
            </div>
            ...
            <div className="flex flex-col w-full">
              ...
              {/* ACTIVE TAB ROWS */}
              {activeTab === "Active" && tenantData.map((row, idx) => {
              ...
              {/* PENDING TAB ROWS */}
              {activeTab === "Pending" && pendingData.map((row, idx) => {
              ...
              {/* SUSPENDED TAB ROWS */}
              {activeTab === "Suspended" && suspendedData.map((row, idx) => {
              ...
              {/* TERMINATED TAB ROWS */}
              {activeTab === "Terminated" && terminatedData.map((row, idx) => {
