...
export default function NavbarClient() {
  ...
  return (
    <div className="w-64 h-[855px] pt-20 pb-2.5 bg-amber-400 shadow-[2px_4px_18px_0px_rgba(0,0,0,0.25)] inline-flex flex-col justify-start items-center gap-7">
        <div data-showaccounts="true" data-showanalytics="true" data-showaudit="false" data-showdashboard="true" data-showinventory="false" data-showorders="false" data-showrestockalert="false" data-showstockifyhub="false" data-showstorefront="false" data-showstoresettings="false" data-showsubscriptionbilling="true" data-showtenantmanagement="false" data-showuseradmin="false" className="self-stretch h-[563px] flex flex-col justify-start items-center gap-2.5 overflow-hidden">
            <div data-icon="true" data-property-1="Hover" className="w-64 h-14 pl-5 pr-12 py-6 bg-lime-950 shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] inline-flex justify-start items-center gap-2.5">
            <div className="w-10 h-10 relative overflow-hidden">
                <div className="w-9 h-7 left-[3.42px] top-[6.83px] absolute bg-amber-400" />
            </div>
            <div data-property-1="x1" className="w-16 h-9 relative">
                <div className="left-0 top-[10px] absolute justify-center text-amber-400 text-base font-bold font-['Inter']">Dashboard</div>
            </div>
            </div>
