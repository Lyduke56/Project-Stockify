  ...
  return (
    <div className="flex flex-col gap-8 w-full animate-in fade-in duration-500">
      ...
      <div className="space-y-1">
        <h2 className="text-[#385E31] text-3xl font-bold font-['Inter']">Welcome to the storefront, Client!</h2>
        <p className="text-[#385E31]/60 text-l font-bold font-['Inter']">Utilize the parameters below to give life to your store.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 mt-4">
        ...
        <div className="flex items-center gap-3">
          <label className="text-[#385E31] font-bold font-['Inter'] text-sm w-32">Shop Logo:</label>
          ...
          <button className="bg-[#385E31] text-white px-6 py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-wider hover:brightness-110">Upload</button>
        </div>
        <div className="flex items-center gap-3">
          <label className="text-[#385E31] font-bold font-['Inter'] text-sm w-32">Banner Image:</label>
          <input type="text" placeholder="filename.png" className="flex-1 p-2.5 rounded-lg bg-[#FDE68A]/50 border border-[#F7B71D]/30 text-[#385E31] text-xs font-bold" />
          <button className="bg-[#385E31] text-white px-6 py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-wider hover:brightness-110">Upload</button>
        </div>
        ...
        {[
          ...
          <div key={item.label} className="flex items-center gap-3">
            <label className="text-[#385E31] font-bold font-['Inter'] text-sm w-32">{item.label}</label>
            {item.type === "select" ? (
      ...
      <div className="mt-4 pt-6 border-t-3 border-[#385E31]/10">
