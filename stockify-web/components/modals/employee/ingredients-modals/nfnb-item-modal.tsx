...
export default function NfbItemModal({ mode, tenantId, initial, onSave, onClose, colors }: NfbItemModalProps) {
  ...
  return (
    <ModalBackdrop onClose={onClose}>
      <motion.div
        ...
        className="w-full max-w-[820px] bg-background rounded-[32px] overflow-hidden border-[1.5px] border-accent/20 shadow-[0_32px_80px_rgba(58,97,49,0.2)] flex flex-col md:flex-row font-inter"
        style={{ ...modalStyles, minHeight: 500 }}
      >
        {/* LEFT SIDEBAR */}
        <div className="w-full md:w-[280px] bg-primary p-10 flex flex-col relative overflow-hidden shrink-0">
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm font-bold text-[var(--color-sidebar-text,#FFF9D7)]">NF&B Item</span>
            </div>
        ...
        <div className="flex-1 flex flex-col relative bg-background/50 backdrop-blur-sm">
          ...
          <div className="flex-1 overflow-y-auto p-10 [&::-webkit-scrollbar]:w-[5px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-primary/15 [&::-webkit-scrollbar-thumb]:rounded-full">
            ...
            <div className="mb-8">
              <span className="bg-accent/15 text-primary text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest">Item Details</span>
              <h3 className="text-2xl font-black text-primary mt-2 font-raleway italic">Stock Information</h3>
            </div>
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div>
                ...
                {loadingCats ? (
                  <div className="flex items-center gap-2 text-primary/50 text-sm py-3"><Loader2 size={16} className="animate-spin" /> Loading…</div>
                ) : (
          ...
          <div className="px-8 py-5 border-t border-primary/10 bg-background/80 flex justify-between items-center z-20">
            <button onClick={onClose} className="text-primary/50 text-sm font-bold hover:text-primary transition-colors">
              Cancel
            </button>
            <button
              onClick={handleSave}
