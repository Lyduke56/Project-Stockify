        ...
        <div className="w-full md:w-[280px] bg-[#3A6131] p-10 flex flex-col relative overflow-hidden shrink-0">
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <p className="text-[#FFFCEB]/60 text-xs font-medium leading-relaxed mb-10">
              Track non-food & beverage stock with discrete unit quantities. No recipe conversion needed.
            </p>
          ...
          <div className="flex-1 overflow-y-auto p-10 [&::-webkit-scrollbar]:w-[5px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-[#3A6131]/15 [&::-webkit-scrollbar-thumb]:rounded-full">
            ...
            <div className="grid grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input className={inputStyle} value={form.sku} onChange={(e) => set("sku", e.target.value)} placeholder="NFB-CHR-01" />
              </div>
              ...
              {/* Reorder Threshold */}
              <div>
                <label className={labelStyle}>Reorder Alert Threshold</label>
              ...
              <div className="bg-[#3A6131]/5 p-5 rounded-[24px] border border-[#3A6131]/10">
                <label className={labelStyle}>Unit Price (per {form.unit_of_measure || "unit"})</label>
                <div className="flex items-center text-2xl font-black text-[#3A6131]">
                  <span className="mr-2 opacity-30">₱</span>
                  <input type="number" className="bg-transparent border-none p-0 focus:ring-0 w-full font-black text-xl" value={form.unit_price} onChange={(e) => set("unit_price", e.target.value)} placeholder="0.00" />
                </div>
              </div>
            </div>
          </div>
