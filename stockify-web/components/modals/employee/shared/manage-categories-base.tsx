...
export default function ManageCategoriesBase({
  tenantId, type, title, contextLabel, placeholder, onClose,
}: Props) {
      ...
      >
        ...
        <div className="w-full md:w-[260px] bg-[#3A6131] p-10 flex flex-col relative overflow-hidden shrink-0">
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <span className="text-sm font-bold text-[#FFFCEB]">{contextLabel}</span>
            </div>
        ...
        <div className="flex-1 flex flex-col relative bg-white/50 backdrop-blur-sm min-h-[420px]">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="w-12 h-12 shrink-0 rounded-2xl bg-[#3A6131] text-[#FFFCEB] flex items-center justify-center shadow-md hover:scale-110 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {saving
          ...
          <div className="px-8 py-5 border-t border-[#3A6131]/10 bg-white/80 flex justify-between items-center">
            ...
            <button
              onClick={onClose}
              className="bg-[#3A6131] text-[#FFFCEB] px-8 py-3 rounded-2xl text-sm font-bold hover:opacity-90 transition-opacity"
            >
              Done
            </button>
          </div>
